define (require) ->
	...
	class MostPopularProducer extends Producer
		...
		dispose: ->
			...
			EventsRepository.removeSubscription EventsRepository.MOST_POPULAR, @repoFetchSubscription
			super
		...
		subscribe: (subscriptionKey, options) ->
			...
			EventsRepository.addSubscription EventsRepository.MOST_POPULAR, @repoFetchSubscription
			do @_produceData
