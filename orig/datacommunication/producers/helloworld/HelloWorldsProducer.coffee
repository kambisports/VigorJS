define (require) ->
	...
	class HelloWorldsProducer extends Producer
		...
		dispose: ->
			...
			HelloWorldRepository.removeSubscription HelloWorldRepository.ALL, @repoFetchSubscription
			super
		...
		subscribe: (subscriptionKey, options) ->
			...
			HelloWorldRepository.addSubscription HelloWorldRepository.ALL, @repoFetchSubscription
			do @_produceData
