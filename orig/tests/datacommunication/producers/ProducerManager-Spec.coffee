		...
		describe 'given a valid subscription key', ->
			...
			describe 'to create', ->
				...
				it 'should return a new instance of producer if one has not been instansiated', ->
					producer = producerManager.getProducer SubscriptionKeys.MOST_POPULAR_EVENTS
					expect(producer).toBeDefined()

				it 'should return exisiting producer if one has already been instansiated', ->
					producer1 = producerManager.getProducer SubscriptionKeys.MOST_POPULAR_EVENTS
					producer2 = producerManager.getProducer SubscriptionKeys.MOST_POPULAR_EVENTS
			...
			describe 'to remove', ->
				it 'should dispose the producer and remove it from list of producers', ->
					...
					producerManager.removeProducer SubscriptionKeys.MOST_POPULAR_EVENTS
