	...
	describe 'A DataCommunicationManager', ->
		...
		describe 'using subscribe', ->
			...
			it 'should add unique component to subscription map', ->
				dataCommunicationManager.subscribe exampleComponent_1.id, SubscriptionKeys.NEW_MOST_POPULAR_EVENTS, exampleComponent_1.callback, {}

				subscriptionComponentList = dataCommunicationManager.subscriptionsWithComponentIdentifiers.get SubscriptionKeys.NEW_MOST_POPULAR_EVENTS
			...
			it 'should add multiple components for same subscription', ->
				...
				dataCommunicationManager.subscribe exampleComponent_1.id, SubscriptionKeys.NEW_MOST_POPULAR_EVENTS, exampleComponent_1.callback, {}
				dataCommunicationManager.subscribe exampleComponent_2.id, SubscriptionKeys.NEW_MOST_POPULAR_EVENTS, exampleComponent_2.callback, {}
		...
		describe 'using unsubscribe', ->
			...
			it 'should remove component from subscription map', ->
				...
				dataCommunicationManager.unsubscribe exampleComponent_1.id, SubscriptionKeys.NEW_MOST_POPULAR_EVENTS
